    ...
    <footer className="bg-[#232e49] shadow dark:bg-gray-900">
        ...
        <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex flex-wrap items-center mb-8 text-m font-medium text-gray-200 sm:mb-0 dark:text-gray-400 containerRedes">
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Adrian™</a>. Todos los derechos reservados.</span>
        </div>
    </footer>
