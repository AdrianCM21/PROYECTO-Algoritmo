...
const IconLinkedin=(props: React.SVGProps<SVGSVGElement>) =>{
  ...
  const IconBxlGmail=(props: React.SVGProps<SVGSVGElement>)=> {
    return (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
...
export {IconGithub,IconFacebook,IconLinkedin,IconBxlGmail}